...
BEGIN
  ...
  "COUNTRY_CODE" VARCHAR2(3 CHAR) CONSTRAINT "SYMBOLS_NN08" NOT NULL ENABLE,
  "CREATION_USR" VARCHAR2(64 CHAR) CONSTRAINT "SYMBOLS_NN09" NOT NULL ENABLE,
  "CREATION_DT" DATE CONSTRAINT "SYMBOLS_NN10" NOT NULL ENABLE,
