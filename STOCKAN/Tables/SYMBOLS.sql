...
BEGIN
  ...
  "SYMBOL" VARCHAR2(16 CHAR) CONSTRAINT "SYMBOLS_NN03" NOT NULL ENABLE,
  "SYMBOL_TYPE_ID" NUMBER CONSTRAINT "SYMBOLS_NN04" NOT NULL ENABLE,
  "ISIN" VARCHAR2(32 CHAR) CONSTRAINT "SYMBOLS_NN05" NOT NULL ENABLE,
  "DIRECTORY" VARCHAR2(32 CHAR) CONSTRAINT "SYMBOLS_NN06" NOT NULL ENABLE,
  "FILE" VARCHAR2(32 CHAR) CONSTRAINT "SYMBOLS_NN07" NOT NULL ENABLE,
  "EXT_TABLE_NAME" VARCHAR2(32 CHAR) CONSTRAINT "SYMBOLS_NN08" NOT NULL ENABLE,
  "COUNTRY_CODE" VARCHAR2(3 CHAR) CONSTRAINT "SYMBOLS_NN09" NOT NULL ENABLE,
  "CREATION_USR" VARCHAR2(64 CHAR) CONSTRAINT "SYMBOLS_NN10" NOT NULL ENABLE,
  "CREATION_DT" DATE CONSTRAINT "SYMBOLS_NN11" NOT NULL ENABLE,
